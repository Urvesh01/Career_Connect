(function (global, factory) {
    ...
    var CloudinaryImageComponent = /** @class */ (function () {
         ...
         */
        CloudinaryImageComponent.prototype.syncAttributes = function () {
            var _this = this;
            ['alt', 'width', 'height', 'loading'].forEach(function (attr) {
                var isAttributeSet = _this[attr] !== undefined && _this[attr] !== null;
                if (isAttributeSet) {
                    _this.el.nativeElement.children[0].setAttribute(attr, _this[attr]);
                    _this.el.nativeElement.removeAttribute(attr);
                }
                else {
                    _this.el.nativeElement.children[0].removeAttribute(attr);
                }
            });
        };
    ...
    var CloudinaryVideoComponent = /** @class */ (function () {
        ...
        CloudinaryVideoComponent.prototype.ngOnInit = function () {
            this.htmlVideoLayerInstance = new html.HtmlVideoLayer(this.el.nativeElement.children[0], this.cldVid, this.sources, this.plugins, this.getVideoAttributes(), this.cldPoster, { useFetchFormat: this.useFetchFormat });
