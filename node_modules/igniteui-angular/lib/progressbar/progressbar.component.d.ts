...
export declare abstract class BaseProgressDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<BaseProgressDirective, never, never, { "indeterminate": { "alias": "indeterminate"; "required": false; }; "animationDuration": { "alias": "animationDuration"; "required": false; }; "step": { "alias": "step"; "required": false; }; "animate": { "alias": "animate"; "required": false; }; "max": { "alias": "max"; "required": false; }; "value": { "alias": "value"; "required": false; }; }, { "progressChanged": "progressChanged"; }, never, never, true, never>;
...
export declare class IgxCircularProgressBarComponent extends BaseProgressDirective implements AfterViewInit, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxCircularProgressBarComponent, "igx-circular-bar", never, { "id": { "alias": "id"; "required": false; }; "isIndeterminate": { "alias": "isIndeterminate"; "required": false; }; "textVisibility": { "alias": "textVisibility"; "required": false; }; "text": { "alias": "text"; "required": false; }; }, {}, ["textTemplate", "gradientTemplate"], never, true, never>;
    static ngAcceptInputType_textVisibility: unknown;
}
