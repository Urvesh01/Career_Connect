...
export declare abstract class IgxNotificationsDirective extends IgxToggleDirective implements IToggleView, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<IgxNotificationsDirective, never, never, { "ariaLive": { "alias": "ariaLive"; "required": false; }; "autoHide": { "alias": "autoHide"; "required": false; }; "displayTime": { "alias": "displayTime"; "required": false; }; "outlet": { "alias": "outlet"; "required": false; }; "isVisible": { "alias": "isVisible"; "required": false; }; }, {}, never, never, true, never>;
