...
export declare class IgxFlexDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<IgxFlexDirective, "[igxFlex]", never, { "grow": { "alias": "igxFlexGrow"; "required": false; }; "shrink": { "alias": "igxFlexShrink"; "required": false; }; "flex": { "alias": "igxFlex"; "required": false; }; "order": { "alias": "igxFlexOrder"; "required": false; }; "basis": { "alias": "igxFlexBasis"; "required": false; }; }, {}, never, never, true, never>;
}
