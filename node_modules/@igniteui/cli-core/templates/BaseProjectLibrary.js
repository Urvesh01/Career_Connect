...
exports.BaseProjectLibrary = void 0;
...
class BaseProjectLibrary {
    ...
    get projectIds() {
        ...
        if (!this._projectIds.length) {
            this._projectIds = util_1.Util.getDirectoryNames(path.join(this.rootPath, this._projectsPath));
    ...
    getProject(id) {
        if (this.hasProject(id)) {
            ...
            return projModule.default || projModule;
        }
        return null;
    }
    hasProject(id) {
