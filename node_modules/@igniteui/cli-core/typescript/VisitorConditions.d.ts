 ...
 */
export declare const variableAsParentCondition: (astTransformer: TypeScriptAstTransformer, variableName: string) => (node: ts.Node) => boolean;
/**
 ...
 */
export declare const PropertyAssignmentWithStringLiteralValueCondition: (name: string, literal: string) => (node: ts.Node | ts.ObjectLiteralElementLike) => boolean;
