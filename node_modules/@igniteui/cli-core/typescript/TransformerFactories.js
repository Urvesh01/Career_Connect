...
exports.newImportDeclarationTransformerFactory = exports.newArgumentInMethodCallExpressionTransformerFactory = exports.sortInArrayLiteralTransformerFactory = exports.newMemberInArrayLiteralTransformerFactory = exports.newMemberInObjectLiteralTransformerFactory = void 0;
 ...
 */
const newMemberInObjectLiteralTransformerFactory = (newProperty, visitCondition, expressionCollector, options) => {
    return (context) => {
        return (rootNode) => {
            const visitor = (node) => {
                if (ts.isObjectLiteralExpression(node) && visitCondition(node)) {
                    ...
                    if (ts.isArrayLiteralExpression(existingPropInitializer)) {
                        return updatePropertyAssignmentWithArrayLiteral(newProperty, existingProperty, context, node, expressionCollector, options === null || options === void 0 ? void 0 : options.multiline, options === null || options === void 0 ? void 0 : options.override);
                    }
 ...
 */
const newMemberInArrayLiteralTransformerFactory = (visitCondition, elements, anchorElement, options) => {
    return (context) => {
        return (rootNode) => {
            const visitor = (node) => {
                let anchor;
 ...
 */
const sortInArrayLiteralTransformerFactory = (visitCondition, sortCondition) => {
    return (context) => {
        return (rootNode) => {
            const visitor = (node) => {
                if (ts.isArrayLiteralExpression(node) && visitCondition(node)) {
...
exports.sortInArrayLiteralTransformerFactory = sortInArrayLiteralTransformerFactory;
/**
 ...
 */
function updatePropertyAssignmentWithArrayLiteral(newProperty, existingProperty, context, node, expressionCollector, multiline, override) {
    const existingPropInitializer = ts.isPropertyAssignment(existingProperty)
        ? existingProperty.initializer
        : existingProperty.objectAssignmentInitializer;
    const newPropInitializer = ts.isPropertyAssignment(newProperty)
 ...
 * @param context The transformation context.
 */
function updateProperty(node, existingProperty, newInitializer, context) {
    const updatedProperty = ts.isPropertyAssignment(existingProperty)
        ? context.factory.updatePropertyAssignment(existingProperty, existingProperty.name, newInitializer)
        : context.factory.updateShorthandPropertyAssignment(existingProperty, existingProperty.name, newInitializer);
