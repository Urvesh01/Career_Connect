import { ExecSyncOptions, SpawnSyncOptions } from "child_process";
...
export declare class Util {
    ...
    static ensureDirectoryExists(dirPath: any): void;
     ...
     */
    static execSync(command: string, options?: ExecSyncOptions): string | Buffer;
    /**
     ...
     */
    static spawnSync(command: string, args: string[], options?: SpawnSyncOptions): import("child_process").SpawnSyncReturns<string | Buffer>;
    /**
