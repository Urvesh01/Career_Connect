...
class Util {
    ...
    static processTemplates(sourcePath_1, destinationPath_1, configuration_1, delimiters_1) {
        return __awaiter(this, arguments, void 0, function* (sourcePath, destinationPath, configuration, delimiters, validate = true) {
