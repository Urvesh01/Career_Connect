 ...
 */
export interface ObjectLiteralExpressionEditOptions extends LiteralExpressionOptionsBase {
    /**
 ...
 */
export interface ArrayLiteralExpressionEditOptions extends LiteralExpressionOptionsBase {
    /**
