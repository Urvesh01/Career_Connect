...
BaseReCaptchaComponentDirective.ɵfac = function BaseReCaptchaComponentDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || BaseReCaptchaComponentDirective)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ScriptService));
};
...
InvisibleReCaptchaComponent.ɵfac = function InvisibleReCaptchaComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || InvisibleReCaptchaComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ScriptService));
};
...
ReCaptcha2Component.ɵfac = function ReCaptcha2Component_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ReCaptcha2Component)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(ScriptService));
};
...
ReCaptchaV3Service.ɵfac = function ReCaptchaV3Service_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ReCaptchaV3Service)(ɵɵinject(ScriptService), ɵɵinject(NgZone));
};
